...
<!-- navbar -->
    ...
    <div class="container" style="background-color: rgb(180, 180, 180); box-shadow: 0 50px 70px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); height: 870px;box-shadow: 2px 2px 200px red;">  
        ...
        <article style="margin-left: 200px">
          <div style="margin-right: 150px;padding-top: 20px;padding-left: 50px; padding-right: 5px;">
            <h1 style="text-align: left; size: 60px;color: white; text-shadow: 2px 2px 5px red">ตารางข้อมูลรายชื่อพนักงาน</h1><br>
