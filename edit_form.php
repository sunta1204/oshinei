...
<body>
  <!-- navbar -->
	<nav class="navbar navbar-dark bg-dark" style="background-color: rgb(0, 93, 255); border: 5px solid #41434B;">
        <button class="btn btn-outline-primary " type="button" onclick="window.location.href='emp_page.php'" style="font-size: 26px;">Oshinei KhonKaen</button> 
	...
	<div class="container" style="background-color: rgb(180, 180, 180); box-shadow: 0 50px 70px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); height: 500px;box-shadow: 2px 2px 200px red;">  
    <nav style="float: left;width: 200px;height: 400px;margin-top: 20px;margin-bottom: 5px;">
      ...
      <nav class="w3-panel w3-border-white w3-leftbar w3-rightbar w3-topbar w3-bottombar" ><br>
        <a href="emp_page.php"><input type="button" value="กลับสู่หน้าหลัก" class="btn btn-primary form-control"></a><br><br>
    ...
    <div style="margin-right: 50px;padding-top: 20px;padding-left: 50px; padding-right: 5px;">
		<h1 style="text-align: left; size: 60px;color: white; text-shadow: 2px 2px 5px red;">รายละเอียด</h1><br>
		<form action="edit-profile/edit-profile.php" method="post">
			<input type="hidden" name="emp_id" value="<?=$_SESSION["emp_id"]?>"><br>
			<div class="form-row">
				<div class="form-group col-6">
					<label style="font-size: 20px;">Email</label>
					<input type="email" name="emp_email" class="form-control" value="<?=$_SESSION["emp_email"]?>">
				</div>
				<div class="form-group col-6">
					<label style="font-size: 20px;">Fullname</label>
					<input type="text" name="emp_fullname" class="form-control" value="<?=$_SESSION["emp_fullname"] ?>" >
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-3">
					<label style="font-size: 20px;">อายุ</label>
					<input type="text" name="emp_year" class="form-control" value="<?=$_SESSION["emp_year"]?>">
				</div>
				<div class="form-group col-3">
					<label style="font-size: 20px;">เพศ</label>
					<input type="text" name="emp_sex" class="form-control" value="<?=$_SESSION["emp_sex"]?>">
				</div>
				<div class="form-group col-6">
					<label style="font-size: 20px;">เลขบัตรประชาชน</label>
					<input type="text" name="emp_cardid" class="form-control" value="<?=$_SESSION["emp_cardid"]?>">
				</div>
			</div>
			<div class="form-row">
				<label style="font-size: 20px;">ที่อยู่</label>
				<input type="text" class="form-control" name="emp_address" value="<?=$_SESSION["emp_address"]?>">
			</div><br>
			<div class="form-row">
				<input type="submit" value="แก้ไขข้อมูลส่วนตัว" class="btn btn-primary">
			</div>
		</form>
  	</div>
  </article>
